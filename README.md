...
![ぶるーみんぐれこーどロゴ](assets/images/logo2.png)
...
## ■ 使用ライブラリ
本サービスでは、以下の外部ライブラリを利用しています。
canvas-confetti
作者: Kiril Vatev
ライセンス: MIT License
詳細: https://www.kirilv.com/canvas-confetti/
説明: 花が満開になった際の紙吹雪（花びら）演出に利用しています。